	...
	if(isset($_POST['submitComment']))
	{
		...
		if(!empty($_POST['articleTitle']) )
		{
			...
			if(!empty($_POST['articleBody']))
			{
				...
				$sql = "INSERT INTO tblArticles (title, body, author) VALUES ('" . $_POST['articleTitle']."','" .$_POST['articleBody']."','".$_POST['author']."')";
										...
										<td width='70%'>
											...
											<table id='commentsTable' width='100%'>
												<tr>
													...
													<td><b>Article Title :</b> <input id='reportTitle' name='reportTitle' type='text' /></td>
												</tr>
												
												<tr>
													
													<td><b>Article :</b><br /><textarea id='report' name='report' maxlength='5000'cols='100' rows='20'></textarea></td>
												</tr>
