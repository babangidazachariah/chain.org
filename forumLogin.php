...
SESSION_START();
	...
	if(isset($_POST['login']))
	{
		...
		if(!$isError)
		{
			...
			$sql = "SELECT * FROM tblForumUsers WHERE username='". $username . "' AND password = '". $password."'";
									...
									<table width='100%' class='Example_J' >
										...
										<tr>
											<td width='100%' align='center'>
												...
												<table width='50%'>
													<tr>
														<td align='center' colspan='2'><font color='red' size='6'><b>Users Login!!!</b></font></td>
													...
													<tr>
														<td></td><td  align='left'><button class='sendButton' name='login' id='login'>Login</button><button class='sendButton' name='register' id='register'>Register</button></td>
